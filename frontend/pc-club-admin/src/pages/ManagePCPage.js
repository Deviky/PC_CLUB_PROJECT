...
const ManagePCPage = () => {
  ...
  const handleStatusUpdate = async (pcId, newStatus) => {
    try {
      const response = await fetch("https://dennis.michurin.fvds.ru/pc-service/pc/change-status", {
        method: "PATCH",
        headers: {
  ...
  const handleDeletePc = async (pcId) => {
    try {
      const response = await fetch(`https://dennis.michurin.fvds.ru/pc-service/pc/delete/${pcId}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
  ...
  const handleCreatePc = async (requestData) => {
    try {
      const response = await fetch("https://dennis.michurin.fvds.ru/pc-service/pc/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
      ...
      if (data.message && data.message.startsWith("Ошибка")) {
        ...
        const updatedResponse = await fetch("https://dennis.michurin.fvds.ru/pc-service/pc-group/get-all", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`,
          },
  ...
  const handleCreateGroup = async (requestData) => {
    try {
      const response = await fetch("https://dennis.michurin.fvds.ru/pc-service/pc-group/create", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`,
  ...
  const handleDeleteGroup = async (groupId) => {
    ...
    try {
      const response = await fetch(`https://dennis.michurin.fvds.ru/pc-service/pc-group/delete/${groupId}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
        },
